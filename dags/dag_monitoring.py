...
def _sauvegarder_metrique(type_event, task_id, detail, ds):
    ...
    try:
        ...
        print(f"[ERREUR CALLBACK] Échec sauvegarde métrique : {e}")  # Ne pas faire échouer le callback si la DB est inaccessible
...
def pipeline_monitoring():
    ...
    montant REAL, marge REAL, segment TEXT, charge_le TEXT
);
